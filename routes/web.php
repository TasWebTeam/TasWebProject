...
Route::post('/medicamentos/introducirMedicamento', [ProcesarRecetaController::class, 'introducirMedicamento'])
    ->name('introducirMedicamento');
...
Route::post('/procesarReceta', [ProcesarRecetaController::class, 'procesarReceta'])->name('procesarReceta');