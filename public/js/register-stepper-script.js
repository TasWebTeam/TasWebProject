document.addEventListener("DOMContentLoaded", function () {
    ...
    function actualizarStepper(pasoActual) {
        const allSteppers = document.querySelectorAll(".stepper-wrapper");
        
        allSteppers.forEach(stepperWrapper => {
            const items = stepperWrapper.querySelectorAll(".stepper-item");
            const lines = stepperWrapper.querySelectorAll(".stepper-line");
